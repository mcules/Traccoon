...
async def test_reiner_werkzeugverlauf_behaelt_kopf_und_juengstes(db, monkeypatch):
    """Der Fall ABC-4: 60 Runden nur Werkzeug-Aufrufe, keine einzige user/system-Nachricht
...
async def test_uebergabe_traegt_den_faden_weiter(db, monkeypatch):
    ...
    den letzten Satz. ABC-12 begann am 2026-08-07 drei Läufe hintereinander mit derselben
