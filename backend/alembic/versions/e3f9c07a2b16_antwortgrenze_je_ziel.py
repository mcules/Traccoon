"""Antwortgrenze je Ziel statt einer pauschalen Obergrenze (ABC-31)

`MAX_RESPONSE_CHARS = 4000` galt für jedes Ziel gleichermaßen. Für Gegenstellen, die ihre
Lage bewusst in EINEM Abruf liefern, ist das zu wenig: die GameProj-Bot-API antwortet mit rund
