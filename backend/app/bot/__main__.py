...
async def _vokabular() -> str:
    ...
    Whisper hört „Trakon" statt „Traccoon" und „Terra 1 und 30" statt „ABC-31", weil kein
...
async def _transkribieren_qwen(audio: bytes, medienart: str, mime_type: str | None) -> str:
    ...
    Gemessen am 2026-08-07 mit derselben Aufnahme: „ABC-31 in Trakong" (whisper.cpp/GPU)
    gegen „ABC-31 in Traccoon" (hier) — bei 0,5 s statt 3,1 s auf der CPU.
    """
    import httpx
