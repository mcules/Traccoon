...
ACTIONS: dict[str, list[dict]] = {
    ...
    "spam_evaluate": [
        ...
        _f("spam.befunde_text", "text", "ctx.what_gave_it_away_as_a_sentence"),
        _f("spam.bekannter_kontakt", "boolean", "ctx.sender_is_among_the_known_contacts"),
        _f("spam.geklaert", "boolean", "ctx.the_memory_agrees_about_this_sender"),
        _f("spam.geklaert_urteil", "text", "ctx.spam_ham_only_once_settled"),
    ...
    "spam_card": [_f("spam.verdict_id", "number", "ctx.verdict_row_created"),
                  ...
                  _f("spam.karte_titel", "text", "ctx.heading_for_the_notify_node"),
                  _f("spam.karte_text", "text", "ctx.text_for_the_notify_node"),
                  _f("spam.karte_art", "text", "ctx.spam_auto_spam_review_decides_the_buttons"),
                  _f("spam.karte_faellig", "boolean", "ctx.is_a_card_due_now")],
