...
AKTIONEN: dict[str, list[dict]] = {
    ...
    "assistent_auftrag": [
        _f("auftrag.task_id", "zahl", "Nummer des Auftrags im Assistenten-Eingang"),
        _f("auftrag.status", "text", "approved = läuft, new = wartet auf Freigabe"),
        _f("assistent.output", "text", "Antwort des Assistenten (nur mit „warten“)"),
        _f("assistent.status", "text", "done oder error (nur mit „warten“)"),
    ],
    "antwort": [
        _f("antwort", "text/objekt", "Was dieser Lauf seinem Auslöser zurückgibt"),
    ],
    "messwert": [
