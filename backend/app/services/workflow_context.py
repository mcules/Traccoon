...
AUSLOESER: dict[str, list[dict]] = {
    ...
    "(Mail-Aktion)": [
        ...
        _f("mail.account_id", "zahl", "Konto, aus dem die Mail stammt"),
        _f("mail.folder", "text", "Ordner"),
        _f("mail.uid", "zahl", "Nachricht im Ordner"),
        _f("mail.subject", "text", "Betreff"),
        _f("mail.from", "text", "Absenderadresse"),
        _f("mail.text", "text", "Text der Nachricht"),
        _f("mail.attachments", "liste", "Alle Anhänge (index, filename, content_type, size)"),
        _f("attachment.index", "zahl", "Gewählter Anhang (nur beim Knopf am Anhang)"),
...
AKTIONEN: dict[str, list[dict]] = {
    ...
    "assistant_task": [
        _f("task.task_id", "zahl", "Nummer des Auftrags im Assistenten-Eingang"),
    ...
    "mail_attachment": [
        ...
        _f("attachment.size", "zahl", "Größe in Bytes"),
        _f("attachment.base64", "text", "Der Inhalt, wie ihn Werkzeuge erwarten"),
    ],
    "answer": [
        _f("answer", "text/objekt", "Was dieser Lauf seinem Auslöser zurückgibt"),
    ],
    "metric_record": [
        _f("metric.value", "zahl", "Der eben festgehaltene Wert"),
        _f("metric.per_day", "zahl", "Änderung pro Tag (negativ = fällt)"),
        _f("metric.days_left", "zahl", "Tage bis zum Zielwert (leer, wenn unklar)"),
        _f("metric.empty_at", "text", "Datum, an dem der Zielwert erreicht wird"),
        _f("metric.fit", "zahl", "Wie gut die Gerade passt (0–1)"),
    ...
    "metric_read": [
        ...
        _f("metric.still", "ja/nein", "Reihe schweigt länger als erlaubt"),
        _f("metric.still_melden", "ja/nein", "Jetzt melden — einmal je Stille-Phase"),
        _f("metric.gefunden", "ja/nein", "Reihe existiert überhaupt"),
        _f("metric.days_left", "zahl", "Tage bis zum Zielwert (leer, wenn unklar)"),
        _f("metric.empty_at", "text", "Datum, an dem der Zielwert erreicht wird"),
        _f("metric.per_day", "zahl", "Änderung pro Tag (negativ = fällt)"),
        _f("metric.points", "zahl", "Wieviele Messpunkte im Fenster liegen"),
    ...
    "note_append": [
        _f("notiz.ok", "ja/nein", "Notiz wurde geschrieben"),
        _f("notiz.error", "text", "Fehlertext, wenn nicht"),
    ],
    "spam_evaluate": [
        ...
        _f("spam.modellurteil", "ja/nein", "Lokales Modell nennt einen Betrugsversuch"),
    ...
    "spam_card": [_f("spam.verdict_id", "zahl", "Angelegte Urteils-Zeile"),
                  ...
                  _f("spam.karte_faellig", "ja/nein", "Ist jetzt eine Karte dran?")],
