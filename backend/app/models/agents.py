...
class AgentDefinition(TimestampMixin, Base):
    ...
    # Learns (TRA-30): reads the memory from the vault of the owner at the beginning and looks
...
class Run(Base):
    ...
    # Runs follow the ticket (TRA-29): archiving a ticket archives its runs. Archived runs
