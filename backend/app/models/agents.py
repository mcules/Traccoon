...
class AgentDefinition(TimestampMixin, Base):
    ...
    # Lernt dazu (ABC-30): liest zu Beginn das Gedächtnis aus dem Vault des Owners und hält nach
...
class Run(Base):
    ...
    # Läufe folgen dem Ticket (ABC-29): Ticket archivieren → Läufe archivieren.
