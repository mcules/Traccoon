...
class Issue(TimestampMixin, Base):
    ...
    # Hardware-Bezug (ABC-25): Ticket hängt an einem Exemplar. Ein Exemplar sammelt über
    ...
    # Worker-Prozess — ein Neustart mitten in Runde 2 begann wieder bei 1 (ABC-32 am
