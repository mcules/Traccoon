...
Darunter hängt das Feld-Modell nach ALMEX-Vorbild (`Artifacts → Fields → Values`): ein
...
Fremdschlüssel aus `issues`, `hardware_assets` und `workflow_instances` mitzöge:
    ...
    zugeordneter Wert   ArtifactValue / artifact_values         TRA-29 → hoch
    die Sache selbst    Artifact / artifacts                    TRA-29, HW-4
"""
