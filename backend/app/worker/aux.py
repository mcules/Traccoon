...
Vorläufer Predecessor hatte dafür einen `auxiliary:`-Block mit eigenem Modell **je Aufgabe**
...
async def aux_chat(db: AsyncSession, *, owner_id: int | None, task: str, messages: list[dict],
    ...
    try:
        # Zeitdeckel: eine Nebenaufgabe darf den Hauptlauf nicht aufhalten. Predecessor lief hier
