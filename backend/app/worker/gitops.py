...
async def diff_text(ctx: GitCtx, max_chars: int = 20000) -> str:
    ...
    of a word took revenge on 2026-08-07: with TRA-32 the reviewer saw a compose block that
    ...
    # everything main has gained since the real branching as "deleted"; with TRA-31 on
