...
export const ACTION_SPECS: Record<AutoActionName, ActionSpec> = {
  ...
  notify: {
    ...
    fields: [
      ...
      { key: "throttle_minutes", label: "action_fields.hoechstens_alle_minuten", type: "number",
        hint: "action_fields.0_aus_der_ablauf_laeuft_weiterhin_bei_jedem_"},
      { key: "throttle_key", label: "action_fields.drossel_schluessel", type: "text",
  ...
  note_append: {
    ...
    fields: [
      { key: "path", label: "action_fields.notiz_pfad", type: "text", required: true,
      ...
      { key: "heading", label: "action_fields.abschnitt_optional", type: "text",
  ...
  series_record: {
    summary: "action_fields.schreibt_einen_punkt_in_eine_datenreihe",
    subjects: ["standalone"],
    fields: [
      { key: "series", label: "Reihe", type: "text", required: true,
        placeholder: "tracker.shelter",
        hint: "action_fields.schluessel_der_reihe_sie_entsteht_beim_ersten" },
      { key: "kind", label: "Art", type: "select",
        options: [["number", "Zahl"], ["location", "Standort"], ["text", "Text"]],
        hint: "action_fields.gilt_nur_wenn_die_reihe_neu_entsteht" },
      ...
      { key: "ts", label: "Zeitpunkt", type: "text",
        ...
        hint: "action_fields.leer_heisst_jetzt_unix_sekunden_oder_iso" },
      { key: "name", label: "Anzeigename", type: "text", placeholder: "Shelter" },
      { key: "color", label: "Farbe", type: "text", placeholder: "#3b82f6" },
      { key: "required", label: "action_fields.ohne_wert_abbrechen", type: "boolean",
        hint: "action_fields.normal_ist_eine_meldung_ohne_wert_kein_fehler" },
    ],
    outcomes: "action_fields.kontext_danach_series_kind_stored_value_lat",
  },
  metric_record: {
    ...
    fields: [
      ...
      { key: "warn_days", label: "action_fields.vorwarnung_tage", type: "number",
        hint: "action_fields.wie_frueh_gewarnt_werden_soll_0_schaltet_die"},
      { key: "window_days", label: "action_fields.trendfenster_tage", type: "number",
  ...
  metric_read: {
    ...
    fields: [
      ...
      { key: "silence_hours", label: "action_fields.verstummt_nach_stunden", type: "number",
