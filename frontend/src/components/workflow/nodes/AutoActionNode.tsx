...
const ACTION_LABEL: Record<string, string> = {
  ...
  note_append: "action.notiz_anhaengen",
  metric_record: "action.messwert",
  metric_read: "action.messreihe_lesen",
  ...
  mail_assistant_task: "action.assistant_task",
  mail_assistant_card: "action.assistant_card",
  mail_assistant_run: "action.assistant_run",
